...
<html>
  ...
  <body class="content-hidden">
    ...
    <script>
      // Check if the page is already in an about:blank iframe
      function isInAboutBlank() {
        try {
          return window.parent.location.href.startsWith('about:blank');
        } catch (e) {
          // If we can't access parent due to cross-origin, we're probably not in about:blank
          return false;
        }
      }
      ...
      window.onload = function() {
        // If we're in an about:blank iframe, show the content
        if (isInAboutBlank()) {
          document.body.classList.remove('content-hidden');
          document.getElementById('aboutBlankPopup').style.display = 'none';
        } else {
          // Otherwise, keep showing the popup and hide the content
          document.body.classList.add('content-hidden');
          document.getElementById('aboutBlankPopup').style.display = 'flex';
        }
